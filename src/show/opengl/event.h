...
public:
        ...
        const Variant<add_object, delete_all_objects, delete_object, mouse_wheel, parent_resized, reset_view, set_ambient,
                      ...
                      set_wireframe_color_rgb, show_convex_hull_2d, show_dft, show_effect, show_fog, show_materials, show_object,
                      show_optical_flow, show_shadow, show_smooth, show_wireframe, toggle_fullscreen>
                event;
