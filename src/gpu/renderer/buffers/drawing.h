...
public:
        ...
        void set_lighting_color(const numerical::Vector3f& color) const;
        void set_background_color(const numerical::Vector3f& color) const;
        void set_wireframe_color(const numerical::Vector3f& color) const;
        void set_clip_plane(const numerical::Vector4d& equation, bool enabled) const;
        void set_clip_plane_color(const numerical::Vector3f& color) const;
        void set_viewport(const numerical::Vector2d& center, const numerical::Vector2d& factor) const;
        void set_normal_color_positive(const numerical::Vector3f& color) const;
        void set_normal_color_negative(const numerical::Vector3f& color) const;
        void set_normal_length(float length) const;
        void set_show_materials(bool show) const;
        void set_direction_to_light(const numerical::Vector3f& direction) const;
        void set_lighting_proportions(float front, float side) const;
        void set_direction_to_camera(const numerical::Vector3f& direction) const;
