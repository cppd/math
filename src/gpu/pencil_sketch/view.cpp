...
class Impl final : public View
{
        ...
        void create_vertices()
        {
                ...
                m_vertices = std::make_unique<vulkan::BufferWithMemory>(
                        ...
                        std::vector<uint32_t>({m_graphics_queue.family_index() /*, m_transfer_queue.family_index()*/}),
...
public:
        ...
        ~Impl() override
        {
                ...
                m_instance.device_wait_idle_noexcept("the Vulkan pencil sketch view destructor");
        }
};
}
