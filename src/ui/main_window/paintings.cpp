...
#include "com/math.h"
#include "painter/scenes/cornell_box.h"
              ...
              const PaintingInformationAll& info_all)
{
        ...
        if (!dialog::path_tracing_parameters_for_3d(info_all.parent_window, hardware_concurrency(), info_3d.paint_width,
                                                    info_3d.paint_height, info_3d.max_screen_size, default_sample_count,
                                                    max_sample_count, &thread_count, &width, &height, &samples_per_pixel,
              ...
              const PaintingInformationAll& info_all)
{
        ...
        if (!dialog::path_tracing_parameters_for_nd(info_all.parent_window, N, hardware_concurrency(),
                                                    info_nd.default_screen_size, info_nd.minimum_screen_size,
                                                    info_nd.maximum_screen_size, default_sample_count, max_sample_count,
