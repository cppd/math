...
#include "pipeline_robustness_image_behavior.h"
...
std::string pipeline_robustness_image_behavior_to_string(
        const VkPipelineRobustnessImageBehavior pipeline_robustness_image_behavior)
{
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wswitch"
        switch (pipeline_robustness_image_behavior)
        {
...
#pragma GCC diagnostic pop
        ...
        return "Unknown VkPipelineRobustnessImageBehavior "
               + to_string(enum_to_int(pipeline_robustness_image_behavior));
}
}
