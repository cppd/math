...
public:
        ...
        virtual numerical::Matrix<3 * N, 3 * N, T> predict(
                T dt,
        ...
        [[nodiscard]] virtual const numerical::Vector<3 * N, T>& x() const = 0;
        ...
        [[nodiscard]] virtual T x_to_speed(const numerical::Vector<3 * N, T>& x) const = 0;
