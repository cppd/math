...
namespace ns::filter::filters::direction::filter_1_1_measurement
{
template <typename T>
...
template <typename T>
numerical::Vector<4, T> position_speed_direction_h(const numerical::Vector<6, T>& x, const T reference_angle)
{
        // px = px
        // py = py
        // speed = sqrt(vx*vx + vy*vy)
...
template <typename T>
numerical::Vector<3, T> position_direction_h(const numerical::Vector<6, T>& x, const T reference_angle)
{
        // px = px
        // py = py
        // angle = atan(vy, vx) + angle
...
template <typename T>
numerical::Vector<2, T> speed_direction_h(const numerical::Vector<6, T>& x, const T reference_angle)
{
        // speed = sqrt(vx*vx + vy*vy)
        // angle = atan(vy, vx) + angle
        const T vx = x[1];
...
template <typename T>
numerical::Vector<1, T> direction_h(const numerical::Vector<6, T>& x, const T reference_angle)
{
        // angle = atan(vy, vx) + angle
        const T vx = x[1];
        const T vy = x[3];
