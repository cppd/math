...
#include "filter_1_1_conv.h"
#include "filter_1_1_measurement.h"
#include "filter_1_1_model.h"
#include "init.h"
...
{
namespace conv = filter_1_1_conv;
namespace measurement = filter_1_1_measurement;
namespace model = filter_1_1_model;
...
class Filter final : public Filter11<T>
{
        ...
        {
                filter_.emplace(
                        core::create_sigma_points<6, T>(sigma_points_alpha_), model::x(position_velocity, init),
        ...
        [[nodiscard]] const numerical::Vector<6, T>& x() const
        {
                ASSERT(filter_);
        ...
        [[nodiscard]] const numerical::Matrix<6, 6, T>& p() const
        {
                ASSERT(filter_);
