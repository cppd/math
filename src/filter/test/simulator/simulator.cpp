...
public:
        explicit Simulator(const Config<T>& config)
                : dt_(config.measurement_dt),
                  ...
                  angle_r_(filters::com::wrap_angle(config.angle_r)),
                  ...
                  angle_(filters::com::wrap_angle(config.angle))
        {
        ...
        void move()
        {
                ...
                angle_ = filters::com::wrap_angle(angle_ + angle_drift_);
        }
        ...
        {
                return filters::com::wrap_angle(
                        velocity_.angle + angle_r_ + angle_ + measurements_direction_nd_(engine_));
        }
