...
template <typename T>
class Filter final : public MoveFilter10<T>
{
...
template <typename T>
std::unique_ptr<MoveFilter10<T>> create_move_filter_1_0(
...
#define TEMPLATE(T) template std::unique_ptr<MoveFilter10<T>> create_move_filter_1_0(T, T, T);
