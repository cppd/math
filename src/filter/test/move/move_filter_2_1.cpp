...
template <typename T>
class Filter final : public MoveFilter21<T>
{
...
template <typename T>
std::unique_ptr<MoveFilter21<T>> create_move_filter_2_1(
...
#define TEMPLATE(T) template std::unique_ptr<MoveFilter21<T>> create_move_filter_2_1(T, T, T);
