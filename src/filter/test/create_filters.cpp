...
TestFilterPosition<N, T, ORDER> create_position(const PositionConfig<T>& config, const unsigned i, const T theta)
{
        ...
        const auto name_smooth_all = name + " Smooth All";
        ...
        if constexpr (ORDER == 0)
        {
                return {filters::position::create_position_0<N, T>(
                        ...
                        view::Filter<N, T>(name_smooth_all, color::RGB8(100, 160 - 40 * i, 200)),
                        view::Filter<N, T>(name_smooth_lag, color::RGB8(100, 160 - 40 * i, 255))};
        }
        else if constexpr (ORDER == 1)
        {
                return {filters::position::create_position_1<N, T>(
                        ...
                        view::Filter<N, T>(name_smooth_all, color::RGB8(0, 160 - 40 * i, 200)),
        ...
        else if constexpr (ORDER == 2)
        {
                return {filters::position::create_position_2<N, T>(
                        ...
                        view::Filter<N, T>(name_smooth_all, color::RGB8(0, 160 - 40 * i, 0)),
                        view::Filter<N, T>(name_smooth_lag, color::RGB8(0, 160 - 40 * i, 50))};
        }
        else
        {
                static_assert(false);
