...
void test_imu(const T precision)
{
        ...
        test_equal(
                *a,
                {0.828268407797415102825L, 0.153107912344738161594L, -0.269255351726610421629L,
                 -0.466937862449330791511L},
                precision);
...
void test_marg(const T precision)
{
        ...
        test_equal(
                *a,
                {0.124463110594081722302L, 0.192756008969864434804L, 0.242454332156917833161L,
                 0.942639884540007082128L},
                precision);
