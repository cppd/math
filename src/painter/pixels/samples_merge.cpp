...
#define TEMPLATE_C(C)                                                                       \
        template void merge_color(ColorSamples<C>*, const ColorSamples<C>&);                \
        template void merge_background(BackgroundSamples<C>*, const BackgroundSamples<C>&); \
        template PixelSamples<C> merge_color_and_background(                                \
