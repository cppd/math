...
template <std::size_t N, typename T, typename Color>
void HyperplaneParallelotope<N, T, Color>::set_light_source(const Color& color)
{
        light_source_ = color;
}
...
template <std::size_t N, typename T, typename Color>
const std::optional<Color>& HyperplaneParallelotope<N, T, Color>::light_source() const
{
