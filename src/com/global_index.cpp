...
static_assert(GlobalIndex<2, int>(std::array<int, 2>{10000, 20000}).compute(std::array<unsigned char, 2>{200, 100}) == 1000200);
...
static_assert(GlobalIndex<5, __int128>(std::array<long long, 5>{123456, 789876, 543212, 345678, 987654}).count() ==
              __int128(18084938769185) * __int128(1000000000000000) + 969371161636864);

// stride

static_assert(GlobalIndex<5, unsigned __int128>(std::array<long long, 5>{11111, 22222, 33333, 44444, 55555}).stride(0) == 1);

static_assert(GlobalIndex<5, __int128>(std::array<long long, 5>{11111, 22222, 33333, 44444, 55555}).stride(1) == 11111);

static_assert(GlobalIndex<5, unsigned __int128>(std::array<long long, 5>{11111, 22222, 33333, 44444, 55555}).stride(2) ==
              static_cast<unsigned __int128>(11111) * 22222);

static_assert(GlobalIndex<5, __int128>(std::array<long long, 5>{11111, 22222, 33333, 44444, 55555}).stride(3) ==
              static_cast<__int128>(11111) * 22222 * 33333);

static_assert(GlobalIndex<5, unsigned __int128>(std::array<long long, 5>{11111, 22222, 33333, 44444, 55555}).stride(4) ==
