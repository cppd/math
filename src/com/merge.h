...
concept VectorAndContainer = requires(T1* const v1, const T2& v2)
{
...
template <typename T1, typename T2>
concept SetAndContainer = requires(T1* const v1, const T2& v2)
{
...
template <typename T1, typename T2>
concept VectorAndValue = requires(T1* const v1, T2&& v2)
{
        v1->push_back(std::forward<T2>(v2));
};

template <typename T1, typename T2>
concept SetAndValue = requires(T1* const v1, T2&& v2)
{
        v1->contains(v2);
