...
#include <src/geometry/spatial/intersection/parallelotope.h>
...
namespace
{
namespace test = intersection::parallelotope;
...
void test_performance()
{
        ...
        LOG("Parallelotope<" + to_string(N) + ", " + type_name<T>() + ">: " + to_string_digit_groups(p) + " o/s");
}
