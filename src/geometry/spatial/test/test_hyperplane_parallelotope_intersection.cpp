...
#include <src/geometry/spatial/intersection/hyperplane_parallelotope.h>
...
namespace
{
namespace test = intersection::hyperplane_parallelotope;
...
void test_hyperplane_parallelotope_performance(progress::Ratio* const progress)
{
