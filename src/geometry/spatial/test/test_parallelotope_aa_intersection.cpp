...
#include <src/geometry/spatial/intersection/parallelotope_aa.h>
...
namespace
{
namespace test = intersection::parallelotope_aa;
...
{
        LOG("Test parallelotope AA intersection");
        test_intersection<float>();
        test_intersection<double>();
        test_intersection<long double>();
        LOG("Test parallelotope AA intersection passed");
}
...
void test_performance()
{
        ...
        LOG("ParallelotopeAA<" + to_string(N) + ", " + type_name<T>() + ">: " + to_string_digit_groups(p) + " o/s");
}
...
void test_parallelotope_performance(progress::Ratio* const progress)
{
...
TEST_SMALL("Parallelotope AA Intersection", test_parallelotope_intersection)
TEST_PERFORMANCE("Parallelotope AA Intersection", test_parallelotope_performance)
}
}
