...
T HyperplaneBall<N, T>::intersection_cost()
{
        static const T cost = []
        {
                const double p = spatial::intersection::hyperplane_ball::compute_intersections_per_second<N, T>();
...
#define FUNCTION_INSTANTIATION_N_T(N, T) template T HyperplaneBall<(N), T>::intersection_cost();
